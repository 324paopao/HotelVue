...
const UserAPI = {
   ...
   */
  getInfo() {
    return request.httpRequest<any, UserInfo>({
  ...
  getPage(queryParams: UserPageQuery) {
    return request.httpRequest<any, PageResult<UserPageVO[]>>({
  ...
  getFormData(userId: string) {
    return request.httpRequest<any, UserForm>({
  ...
  import(deptId: string, file: File) {
    ...
    return request.httpRequest<any, ExcelResult>({
  ...
  /** 获取个人中心用户信息 */
  getProfile() {
    return request.httpRequest<any, UserProfileVO>({
