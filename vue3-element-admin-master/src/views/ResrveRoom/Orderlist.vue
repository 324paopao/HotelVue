  ...
  <div class="reserve-record">
    ...
    <el-table :data="tableData" style="width: 100%; margin-top: 20px">
      ...
      <el-table-column label="操作" width="220">
        <template #default="scope">
          <el-link
            v-if="hasAction('支付') && scope.row.payStatus == 0"
            type="success"
    ...
    <div style="margin-top: 16px; text-align: right">
      <el-pagination
        v-model:current-page="Seach1.PageIndex"
        v-model:page-size="Seach1.PageSize"
        :page-sizes="[4, 5, 6]"
        layout="total, sizes, prev, pager, next, jumper"
        :total="Seach1.totleCount"
      />
    </div>
  </div>
</template>
...
const zhifu = async (row: any) => {
  ...
  axios
    .post("https://localhost:44384/api/alipay/pay", null, { params: params1 })
